...
def train_epoch_kag_netowrk(train_set, batch_size, optimizer, device, model, num_choice, loss_func):
	...
	for k, (statements, correct_labels, graphs, cpt_paths, rel_paths, qa_pairs, concept_mapping_dicts, passage, input_ids, input_mask, segment_ids) in enumerate(
		...
		flat_logits = model(flat_statements, graphs, input_ids, input_mask, segment_ids)
