...
def train_epoch_kag_netowrk(train_set, batch_size, optimizer, device, model, num_choice, loss_func):
        ...
        for k, (statements, correct_labels, graphs, cpt_paths, rel_paths, qa_pairs, concept_mapping_dicts, passages) in enumerate(
                ...
                print(x2)
                '''
                x1 = list(map(lambda x: x.view(-1), x1))
                x2 = list(map(lambda x: x.view(-1), x2))
...
def train_kagnet_main():
        ...
        pretrain_cpt_emd_path = "../embeddings/concept_glove.max.npy"
        #pretrain_rel_emd_path = "../embeddings/openke_data/embs/glove_initialized/rel.npy"
        pretrain_rel_emd_path = "../embeddings/relation_glove.max.npy"
        ...
        train_set = data_with_graphs_and_paths("../datasets/csqa_new/train_rand_split.jsonl.statements",
                                          ...
                                          "../datasets/csqa_new/train_rand_split.jsonl.statements.finetuned.large.-1.npy",
        ...
        dev_set = data_with_graphs_and_paths("../datasets/csqa_new/dev_rand_split.jsonl.statements",
                                          ...
                                          "../datasets/csqa_new/dev_rand_split.jsonl.statements.finetuned.large.-1.npy",
                                          num_choice=4, reload=False, cut_off=3, start=0, end=None)
